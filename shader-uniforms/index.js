...
exports.init = function(gl) {
  ...
  program.offsetUniform = gl.getUniformLocation(program, 'offset');
...
exports.draw = function(gl) {
  ...
  for (var i = 0; i < 4; i++) {
    gl.uniform3fv(program.colorUniform, colors[i]);
    gl.uniform2fv(program.offsetUniform, offsets[i]);
    gl.uniform1f(program.scaleUniform, scales[i]);
    drawTriangle(gl);
  }
}
